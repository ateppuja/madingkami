...
export const INITIAL_CATEGORIES: Category[] = [
  ...
  { id: 'cat-3', name: 'Teknologi & Game', slug: 'teknologi', description: 'Aplikasi web, game buatan siswa, dan proyek IT' },
...
export const INITIAL_KARYA: Karya[] = [
  ...
  },
  {
    ...
    userId: 'user-2',
    categoryId: 'cat-3',
    title: 'EduMath: Game Edukasi Berhitung Seru',
    description: 'Aplikasi web game edukasi matematika berbasis piksel art interaktif untuk membantu siswa SMP belajar aljabar dengan cara menyenangkan.',
    authorName: 'Rian Hidayat',
    authorClass: 'XII RPL 2',
    type: 'aplikasi',
    contentUrl: 'https://images.unsplash.com/photo-1550745165-9bc0b252726f?auto=format&fit=crop&w=1200&q=80',
    appDemoUrl: 'https://example.com/edumath-demo',
    appRepoUrl: 'https://github.com/rianhidayat/edumath',
    status: 'approved',
    likesCount: 52,
    viewsCount: 310,
    featured: true,
  ...
  },
  {
    ...
    userId: 'user-5',
    categoryId: 'cat-3',
    title: 'Smart Library QR Scanner App',
    description: 'Aplikasi PWA untuk peminjaman buku perpustakaan sekolah berbasis scan QR Code kilat.',
    authorName: 'Fahri Pratama',
    authorClass: 'XII RPL 1',
    type: 'aplikasi',
    contentUrl: 'https://images.unsplash.com/photo-1526374965328-7f61d4dc18c5?auto=format&fit=crop&w=1200&q=80',
    appDemoUrl: 'https://example.com/smart-library',
    appRepoUrl: 'https://github.com/fahri/smart-library',
    status: 'pending',
    likesCount: 0,
    viewsCount: 12,
    featured: false,
